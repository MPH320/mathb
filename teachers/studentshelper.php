...
if(isset($_SESSION['teacheruser'])){
	...
	$studentContent .= '<div  style="display:none;" id="ContentPlaceHolder1_gvStudents_divConfirmDelete_0" class="editConfirmDelete">
                                    <span id="ContentPlaceHolder1_gvStudents_Label19_0" style="color:White;font-size:Large;">Are you sure you want to delete this student - ' . $fName . ' ' . $lName . '?</span><br>
                                    <span id="ContentPlaceHolder1_gvStudents_Label18_0" style="color:White;font-size:Large;">All BatterUp inning data will be deleted as well.</span><br>
                                    <input type="submit" name="ctl00$ContentPlaceHolder1$gvStudents$ctl02$btnConfirmDelete" value="Delete" id="ContentPlaceHolder1_gvStudents_btnConfirmDelete_0" onclick="confirmDelete(event)">
                                    <input type="submit" name="ctl00$ContentPlaceHolder1$gvStudents$ctl02$btnCancelDelete" value="Cancel" id="ContentPlaceHolder1_gvStudents_btnCancelDelete_0" onclick="cancelDelete(event)">
                                </div>';
	
	
	
		$studentContent .= '<div class="editStudents" style="display:none;"><br><div id="ContentPlaceHolder1_gvStudents_divEditForm_0">

                                <div class="editModeStudentIcons">
                                    <img src="../images/icon_student.png" alt="Student" class="editModeStudentIcon">
                                    <input type="image" name="ctl00$ContentPlaceHolder1$gvStudents$ctl02$btnEditStudent" id="ContentPlaceHolder1_gvStudents_btnEditStudent_0" title="Update Student" class="editModeStudent" src="../images/invSave.png" onclick="updateStudent(event)">
			...
			$studentContent .= '</select>
                            ...
                            <div style="width:120px;float:left;height:60px;position:relative;overflow:hidden;">    
                                ...
                                <input name="ctl00$ContentPlaceHolder1$gvStudents$ctl02$txtEditStudentMName" type="text" value="';		if (isset($_GET['mName'])) {
	...
	$studentContent .='" id="ContentPlaceHolder1_gvStudents_txtEditStudentMName_0" style="font-size:Medium;height:30px;width:100px;" >
			...
			$studentContent .= '</select>
                            ...
                            <div style="width:300px;float:left;height:60px;position:relative;">
                                <span id="ContentPlaceHolder1_gvStudents_lblClassroomEdit_0" style="color:Silver;">Classroom</span><br>
                                <select name="ctl00$ContentPlaceHolder1$gvStudents$ctl02$ddlClassroomEdit"  id="ContentPlaceHolder1_gvStudents_ddlClassroomEdit_0" style="font-size:Large;height:35px;width:280px;" >
																<option value="No Classroom Assigned">No Classroom Assigned</option>
																
																<option value="2126">testClass</option>
																</select>
                                <input type="hidden" name="ctl00$ContentPlaceHolder1$gvStudents$ctl02$hfClassroomID" id="ContentPlaceHolder1_gvStudents_hfClassroomID_0" >

                            </div>


                                <div class="clear-fix"></div>
                                <input type="hidden" name="ctl00$ContentPlaceHolder1$gvStudents$ctl02$hfStudentID" id="ContentPlaceHolder1_gvStudents_hfStudentID_0" value="16723" ><br>
		...
		$studentContent .= '<div class="studentsRow"><div class="editStudentIcons">';
		$studentContent .= '<img src="../images/icon_student.png" alt="Student" class="editStudentIcon">';
		$studentContent .= '<input type="image" name="ctl00$ContentPlaceHolder1$gvStudents$ctl02$btnEditStudent" id="ContentPlaceHolder1_gvStudents_btnEditStudent_0" title="Edit Student" class="editStudent" src="../images/invEdit.png" onclick="editStudent(event)">';
		$studentContent .= '</div>';
		...
		$studentContent .= '<span id="ContentPlaceHolder1_gvStudents_Label5_0" title="gfdssgf" style="font-size:Medium;">' . $uName .'</span>';
		$studentContent .= '</div>';

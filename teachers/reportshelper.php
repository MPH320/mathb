<?php
    ...
    $reportContent .='</div>';
		$reportContent .='<div style="width:60px;float:left;height:50px;position:relative;overflow:hidden;">';     $reportContent .='<span id="ContentPlaceHolder1_gvStudents_Label12_1" style="color:Silver;">Player#</span><br>';
    $reportContent .='<span id="ContentPlaceHolder1_gvStudents_Label21_1" style="font-size:Medium;">16692</span>';
    $reportContent .='</div>';
		$reportContent .='<div style="width:60px;float:left;height:50px;position:relative;overflow:hidden;">';     $reportContent .='<span id="ContentPlaceHolder1_gvStudents_Label10_1" style="color:Silver;">Grade</span><br>';
    ...
    $reportContent .='<span id="ContentPlaceHolder1_gvStudents_lblStudentFullName_1" style="font-size:Medium;">asfdfdsa, sdfafd sadfdf</span>';
    ...
    $reportContent .='<span id="ContentPlaceHolder1_gvStudents_Label5_1" title="fsdaasf" style="font-size:Medium;">fsdaasf</span>';
    $reportContent .='</div>';

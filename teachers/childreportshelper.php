<?php
	...
	function generateChildReports() {
		...
		$childReportContent .= '<div style="width:60px;float:left;height:50px;position:relative;overflow:hidden;">';     $childReportContent .= '<span id="ContentPlaceHolder1_gvStudents_Label12_0" style="color:Silver;">Player#</span><br>';
		$childReportContent .= '<span id="ContentPlaceHolder1_gvStudents_Label21_0" style="font-size:Medium;">16421</span>';
		$childReportContent .= '</div>';
		$childReportContent .= '<div style="width:60px;float:left;height:50px;position:relative;overflow:hidden;">';     $childReportContent .= '<span id="ContentPlaceHolder1_gvStudents_Label10_0" style="color:Silver;">Grade</span><br>';
		...
		$childReportContent .= '<span id="ContentPlaceHolder1_gvStudents_lblStudentFullName_0" style="font-size:Medium;">fsd, asfd sdf</span>';
		...
		$childReportContent .= '<span id="ContentPlaceHolder1_gvStudents_Label5_0" title="fdsfsd" style="font-size:Medium;">fdsfsd</span>';
		$childReportContent .= '</div>';

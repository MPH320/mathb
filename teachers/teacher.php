	...
	<body class="background">
		...
		<div class="page">
			...
			<div class="page_content">
				<div style="border-top:1px solid #333;">
					<div class="pageWrapper">
						<div class="navTeacherMenu">
							<a href="teacher.php" id="ContentPlaceHolder1_navTeacherTab" class="navTeacher currentSection">Teacher</a>
				...
				<div class="pageWrapper">
					<br /><h1 id="ContentPlaceHolder1_h1Welcome">Welcome teachers to the National Math Bee!</h1>
					<span id="ContentPlaceHolder1_lblWelcome" style="color:Gray;font-size:Medium;">Use this section to setup and administer your classrooms and student BatterUp player accounts. </span><br /><br /><br />
					<h3>Resources</h3>
				</div>
			</div>
			...
			<nav>
				...
				<a href="../teachers/teacher.php" id="navTeachers" class="navTeachers selected">Teacher</a>
			</nav>

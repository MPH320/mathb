<?php
	...
	function generateStudent() {
		...
		$studentContent .= '<span id="ContentPlaceHolder1_gvStudents_lblStudentFullName_0" style="font-size:Medium;">fsd, asfd sdf</span>';
		$studentContent .= '</div>';
		...
		$studentContent .= '<span id="ContentPlaceHolder1_gvStudents_Label5_0" title="fdsfsd" style="font-size:Medium;">fdsfsd</span>';
		$studentContent .= '</div>';
		...
		$studentContent .= '<span id="ContentPlaceHolder1_gvStudents_Label15_0" style="font-size:Medium;">12/31/2004</span>';
		$studentContent .= '</div>';
		...
		$studentContent .= '<span id="ContentPlaceHolder1_gvStudents_Label13_0" style="font-size:Medium;">African-American</span>';
		$studentContent .= '</div>';
